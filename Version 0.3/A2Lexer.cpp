...
void Parser_A2::next_token(vector<string> _id, vector<string> _key, vector<string> _operation, string _line, string _line_num)
{
	...
	for (int i = 0; i < _line.length(); i++)
	{
		...
		******************************************************************/
		for (int index = 4; index < 6; index++)
		{
			if (delim_check == _operation[index])
			{
				...
				result_Stack.push_back(_id[index]);
				delim_check.clear();
			}
		}
		...
		******************************************************************/
		for (int index = 6; index < 21; index++)
		{
				...
				******************************************************************/
				...
				if (delim_check == "=")
				{
					...
					if (!(temp_id.empty()))
					{
						...
						//Pushes the result in a result stack.
						result_Stack.push_back(_id[0]);
						result_Stack.push_back(_id[index]);
