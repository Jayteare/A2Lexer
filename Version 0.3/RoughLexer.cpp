...
int main()
{
	...
	*/
	...
	cout << "-------------------------------------------------" << endl;
	cout << "Project 3 - A2 Lexicon" << endl;
	cout << "-------------------------------------------------" << endl;
	cout << "Authors : Can Dalgir,David Luong,Jonathan Duong. "  << endl;
	...
	cout << "Jonathan Duong e-mail : jonathan.duong94@fullerton.edu " << endl;
	cout << "-------------------------------------------------" << endl;
...
//------------------------------------------------------------------------------
	...
	cout << endl;
	cout << "Starting Language Syntax Analysis..." << endl;
	parser_.result_Stack_Out();
